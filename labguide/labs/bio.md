...
For more information about the space and the equipment, take a look at the "*Equipment* section.

For getting involved with this space you could contact directly with the dedicated laboratory assistant to explain in detail your project.



## The code of conduct 

For a responsible use of biotechnology, we need to maintain a proper level of organization, cleanliness and safety measures.

To address this, the space has some rules that reflect the good practices that are mandatory to adopt. The lack of compliance with these rules would end with the permanent ban to use the space.



**These rules are the following:**

- Prior to start any new project, communicate it to the laboratory assistant, to check the availability of the space, the risk assessment and the guidelines.
